...
sed -i '' -e "s/Year00/Year$year/g" "$mainYear/Day$1.kt" &&
sed -i '' -e "s/00/$1/g" "$mainYear/Day$1.kt" &&
sed -i '' -e "s/template/aoc$year/" "$mainYear/Day$1.kt" &&

mkdir -p "$testYear" &&
cp "$testTemplate/Day00Test.kt" "$testYear/Day$1Test.kt" &&
sed -i '' -e "s/Year00/Year$year/g" "$testYear/Day$1Test.kt" &&
sed -i '' -e "s/00/$1/g" "$testYear/Day$1Test.kt" &&
sed -i '' -e "s/template/aoc$year/" "$testYear/Day$1Test.kt"
